...
const WhatMakesDifferent = () => {
  return (
    <section className="relative bg-black py-20 text-violet-50" aria-label="What Makes Deva Mastery Different">
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-violet-700/20 via-fuchsia-600/20 to-amber-500/20 p-6">
