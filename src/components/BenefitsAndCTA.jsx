...
const BenefitsAndCTA = () => {
  return (
    <section className="relative bg-[#0b0314] py-24 text-violet-50" aria-label="Benefits and Final Call">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="mx-auto mt-16 max-w-3xl overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-violet-700/20 via-fuchsia-600/20 to-amber-500/20 text-center backdrop-blur">
          <img
          ...
          />
          <div className="p-8">
            <p className="text-xl font-medium text-white">“The answers you seek are already within you.”</p>
