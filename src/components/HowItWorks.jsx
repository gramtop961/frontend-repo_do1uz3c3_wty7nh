...
const HowItWorks = () => {
  return (
    <section className="relative bg-black py-20 text-violet-50" aria-label="How Guided Journaling Works">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
          {steps.map(({ icon: Icon, title, text }) => (
            <div key={title} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
